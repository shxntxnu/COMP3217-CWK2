...
testing_split_results.to_csv("TestingResultsMulti.csv", index=False)

# Calculate F1 score
f1_split = f1_score(y_train_split, model.predict(X_train_split), average='weighted')
...
plt.xticks(tick_marks, ['Normal', 'Data Injection', 'Command Injection'])
plt.yticks(tick_marks, ['Normal', 'Data Injection', 'Command Injection'])
